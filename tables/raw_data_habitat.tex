...
\captionsetup{margin=1.15in}
\noindent\begin{longtable}[c]{@{}llrrrrrrrrr}
\caption[Complete habitat data set collected for this study]{Complete habitat data set collected for this study. Box ID numbers correspond to pool numbers: E = Pool~2, S = Pool~3, and N = Pool~1. Species is the host hen for that nest box: \textsc{home} = Hooded Merganser; \textsc{wodu} = Wood Duck. Boxes within refers the number of other nest boxes within 50 or 100 m of the listed Box ID. }\label{tab:raw_data_habitat} \tabularnewline
\toprule
...
Box ID & Species & Min & Max & Mode & Min & Max & Mode & Tree Cover  (m²) & 50 m & 100 m \tabularnewline
\midrule
\endfirsthead
